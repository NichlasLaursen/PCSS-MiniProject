...
public class Client {
    ...
    public void closeEverything(Socket socket, BufferedWriter bufferedWriter, BufferedReader bufferedReader) {
        try {
            if (bufferedWriter != null) { // here we check if bufferedReader is not equal to null in order to avoid
                                          // null-pointer-exception.
                bufferedReader.close();
            }
            if (bufferedReader != null) { // here we check if bufferedWriter is not equal to null in order to avoid
                                          // null-pointer-exception.
                bufferedWriter.close();
            }

            if (socket != null) { // here we check if socket is not equal to null in order to avoid
                                  // null-pointer-exception.
                socket.close();
            }
        } catch (IOException e) {
